        ...
        <div className="ltr-text" style={{ direction: "ltr" }}>
          <ResponsiveContainer width="100%" height={200}>
            <BarChart data={chartData} margin={{ top: 4, right: 8, left: -20, bottom: 0 }}>
              ...
              <Bar dataKey="CPU"     fill="url(#barGrad1)" radius={[2,2,0,0]} maxBarSize={20} />
              <Bar dataKey="RAM"     fill="url(#barGrad2)" radius={[2,2,0,0]} maxBarSize={20} />
              <Bar dataKey="Storage" fill="url(#barGrad3)" radius={[2,2,0,0]} maxBarSize={20} />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </div>
